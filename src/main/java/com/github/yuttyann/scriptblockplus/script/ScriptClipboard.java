 ...
 */
public class ScriptClipboard implements SBClipboard {
    ...
    public ScriptClipboard(@NotNull SBPlayer sbPlayer, @NotNull Location location, @NotNull BlockScriptJson blockScriptJson) {
