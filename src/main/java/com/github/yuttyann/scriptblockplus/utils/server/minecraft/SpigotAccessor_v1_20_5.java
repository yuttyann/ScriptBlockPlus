...
/**
 * Corelate-Bukkit SpigotAccessor_v1_20_5
 * @author yuttyann44581
 */
final class SpigotAccessor_v1_20_5 implements NativeAccessor {
    ...
    SpigotAccessor_v1_20_5() throws ReflectiveOperationException {
        // sendPacket
        ...
        method(NETWORK_CHAT.getClass("IChatBaseComponent$ChatSerializer"))
            ...
            .parameterTypes(String.class, CORE.getClass("HolderLookup$a"))
        ...
        method(NETWORK_CHAT.getClass("IChatBaseComponent$ChatSerializer"))
            ...
            .parameterTypes(NETWORK_CHAT.getClass("IChatBaseComponent"), CORE.getClass("HolderLookup$a"))
    ...
    public Object getComponentFromJson(@NotNull String json) throws ReflectiveOperationException {
        ...
        return m.invokeStatic("ChatSerializer.fromJson", json, m.invokeStatic("CraftRegistry.getMinecraftRegistry"));
    }

    @Override
    @NotNull
    public String getComponentToJson(@NotNull Object component) throws ReflectiveOperationException {
        return (String) m.invokeStatic("ChatSerializer.toJson", component, m.invokeStatic("CraftRegistry.getMinecraftRegistry"));
    }
