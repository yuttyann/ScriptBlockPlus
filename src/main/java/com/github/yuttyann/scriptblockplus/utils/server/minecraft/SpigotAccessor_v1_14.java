...
/**
 * Corelate-Bukkit SpigotAccessor_v1_15
 * @author yuttyann44581
 */
public class SpigotAccessor_v1_14 implements NativeAccessor {
    ...
    SpigotAccessor_v1_14() throws ReflectiveOperationException {
        // sendPacket
        ...
        // getNextContainerId
        method(LEGACY_PATH.getClass("EntityPlayer"))
            .modifiers(PUBLIC, -STATIC, -FINAL)
        ...
        field(LEGACY_PATH.getClass("EntityHuman"))
            .modifiers(PUBLIC, -STATIC, FINAL)
            .fieldType(LEGACY_PATH.getClass("ContainerPlayer"))
        ...
        method(LEGACY_PATH.getClass("Container"))
            .modifiers(PUBLIC, -STATIC, -FINAL)
            .returnType(LEGACY_PATH.getClass("Containers"))
            .emptyParameterTypes()
        ...
        method(LEGACY_PATH.getClass("Container"))
            ...
            .name("setTitle")
            .returnType(void.class)
            .parameterTypes(LEGACY_PATH.getClass("IChatBaseComponent"))
        ...
        method(LEGACY_PATH.getClass("ContainerAccess"))
            .modifiers(STATIC)
            .returnType(LEGACY_PATH.getClass("ContainerAccess"))
            .parameterTypes(LEGACY_PATH.getClass("World"), LEGACY_PATH.getClass("BlockPosition"))
            .findFirst("ContainerAccess.create");
        construct(LEGACY_PATH.getClass("ContainerAnvil"))
            .parameterTypes(int.class, LEGACY_PATH.getClass("PlayerInventory"), LEGACY_PATH.getClass("ContainerAccess"))
        ...
        construct(LEGACY_PATH.getClass("EntityMagmaCube"))
            .parameterTypes(LEGACY_PATH.getClass("EntityTypes"), LEGACY_PATH.getClass("World"))
        ...
        construct(LEGACY_PATH.getClass("PacketPlayOutOpenWindow"))
            .parameterTypes(int.class, LEGACY_PATH.getClass("Containers"), LEGACY_PATH.getClass("IChatBaseComponent"))
