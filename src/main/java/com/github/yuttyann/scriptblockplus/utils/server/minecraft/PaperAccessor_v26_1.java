...
/**
 * Corelate-Bukkit PaperAccessor_v26_1
 * @author yuttyann44581
 */
final class PaperAccessor_v26_1 implements NativeAccessor {
    ...
    PaperAccessor_v26_1() throws ReflectiveOperationException {
        // sendPacket
        ...
        // handleInventoryCloseEvent (Paper は Reason が必須)
        var reasonType = Class.forName("org.bukkit.event.inventory.InventoryCloseEvent$Reason", false, getClass().getClassLoader());
        method(EVENT.getClass("CraftEventFactory"))
            .modifiers(PUBLIC, STATIC)
            .name("handleInventoryCloseEvent")
            .returnType(void.class)
            .parameterTypes(WORLD_ENTITY_PLAYER.getClass("Player"), reasonType)
